...
<div 
  ...
  data-created="{{created_raw}}"
  data-tags="{{tags}}"
  class="all-posts__item"
>
  <div class="comments__commentator latest-posts__commentator">
    <div
      class="comments__commentator__avatar"
    >
    ...
    <div class="commentator__info">
      <div class="commentator__topic topic-page__post-name">
        {{title}}
      </div>
  ...
  <div class="all-posts__comments-likes-container not__link">
    <div class="comments__likes-dislikes">
      <div class="likes-dislikes comments__likes not__link">
        ...
        <div id="likes" class="likes-dislikes__amount not__link">
          {{likes}}
        </div>
      </div>
      <div class="likes-dislikes comments__dislikes not__link">
        ...
        <div id="dislikes" class="likes-dislikes__amount not__link">
          {{dislikes}}
        </div>
      </div>
    </div>
    <div class="all-posts__item-comments">
      <div class="item-comments__comments">
      ...
      <div class="comments__commentator all-posts__comment">
        ...
        >
          <div class="avatar-container">
            <img src="{{last_commentator_avatar}}" alt="avatar" />
            <!--img src="/static/images/logo.png" alt="avatar" /-->
          </div>
        </div>

        <div class="commentator__name-date all-posts__commentator">
          <div class="commentator__name not__link">
            {{last_commentator_name}}
          </div>
          <div class="commentator__date">
...
export const commentariesTemplate = `
<div data-dislikes="{{dislikes}}" data-likes="{{likes}}" data-id={{comment_id}} class="bg-with-stroke post-page__comment">
<div class="comment__commentator-profile">
  ...
  <h5 class="commentator-profile__name">
    {{author}}
  </h5>
...
<div class="comment__body-container">
  <div class="comment__body-header">
    <div class="comment__body-header__date">
      {{created}}
      <!-- DATE OF POST CREATION -->
    </div>
    <div class="comment__body-header__post-id">
      #{{count}}
    </div>
  </div>
  ...
  <div
    class="comments__likes-dislikes comment__body__likes-dislikes"
  >
    <div class="likes-dislikes comments__likes">
      <svg
        class="svg-likes"
        xmlns="http://www.w3.org/2000/svg"
        width="25"
      ...
      <div id="likes" class="likes-dislikes__amount likes__amount">
        {{likes}}
      </div>
    </div>
    <div class="likes-dislikes comments__dislikes">
      <svg
        class="svg-dislikes"
        xmlns="http://www.w3.org/2000/svg"
        width="25"
      ...
      <div id="dislikes" class="likes-dislikes__amount likes__amount">
        {{dislikes}}
      </div>
    </div>
  </div>
